...
//  var biteCounter = 0;
  ...
  var walkModel = {
    animation: loadAnimation("images/contrasaurus/walk.png", 8, 283, 163, 3),
    hitFrames: [
  ...
  var flyModel = {
    animation: Sprite.load("images/contrasaurus/fly.png"),
    hitFrames: [
  ...
  var biteModel = {
    animation: loadAnimation("images/contrasaurus/bite.png", 8, 302, 189, 4),
    hitFrame: [
  ...
  var I = {
    ...
    collideDamage: 2,
    collisionType: "dino",
    hitCircles: currentModel.hitFrames[0],
